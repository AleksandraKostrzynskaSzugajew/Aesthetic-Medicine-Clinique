...
//        List<String> specialtiesAsString =
//        specialtyService.findAll().stream().map(spe -> spe.toString()).collect(Collectors.toList());
//        return specialtiesAsString;
//    }
//
//    @ModelAttribute("procedures")
//    public List<String> procedures() {
//        List<String> proceduresAsString =
//                procedureService.findAll().stream().map(spe -> spe.toString()).collect(Collectors.toList());
//        return proceduresAsString;
//    }
//
//
//
